                ...
                <div className="container">
                    ...
                    <nav className="footer-nav">
                        <div className="col">
                            ...
                            <ul>
                                <li>Email:</li>
                                <li><a href="#">iiitn@ac.in</a></li>
                                <li>Address:</li>
                                <li><a href="#">IIIT Nagpur ,Seminary hills ,Nagpur</a></li>
                                <li>Contact:</li>
                                <li><a href="#">9845851255</a></li>
                            </ul>
                        </div>
                        <div className="col">
                            <h2>Links</h2>
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                         xmlnsXlink="http://www.w3.org/1999/xlink" width="32" height="32"
                                         viewBox="0 0 32 32">
                                        <path
